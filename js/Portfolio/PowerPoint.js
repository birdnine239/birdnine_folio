...
export function renderPowerPoint(container) {
  loadResponsiveCssSet('PowerPoint');  // 폴더 이름만 넘김
  container.innerHTML = `
    <div class="main_title">
      <div class="portfolio_title">
        <img class="title_icon" src="./img/menu/PowerPoint.png" alt="PowerPoint">
        <p>PowerPoint</p>
      </div>
      <div class="search">
        <form action="">
...
function card(file, title, publisher, size, print, page, { bgColor = 'white', extension = 'jpg', displayMode = 'double', extra = '' } = {}) {
  ...
  return `
    <div class="${classes}" style="background: ${bgColor};" data-ebook="./e-book/PowerPoint/${file}.html" data-display="${displayMode}">
      <img src="./img/Portfolio/PowerPoint/${file}.${extension}" alt="${title}">
